...
class MultiSearcher implements \Maho\Search\Lucene\LuceneInterface
{
     ...
     * Array of \Maho\Search\Lucene\LuceneInterface objects
     *
     * @var array
     */
    protected $_indices;
     ...
     */
    public function addIndex(\Maho\Search\Lucene\LuceneInterface $index)
    {
        $this->_indices[] = $index;
    }
    ...
    {
        return \Maho\Search\Lucene\Lucene::getSegmentFileName($generation);
    }
     ...
     *    \Maho\Search\Lucene\LuceneInterface  callbackFunction(\Maho\Search\Lucene\Document $document, array $indices);
     *
