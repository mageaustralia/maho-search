...
abstract class Similarity
{
     ...
     *
     * @var \Maho\Search\Lucene\Search\Similarity
     */
     ...
     * code.
     *
     * @param \Maho\Search\Lucene\Search\Similarity $similarity
     */
    public static function setDefault(\Maho\Search\Lucene\Search\Similarity $similarity)
    {
    ...
    {
        if (!self::$_defaultImpl instanceof \Maho\Search\Lucene\Search\Similarity) {
            self::$_defaultImpl = new \Maho\Search\Lucene\Search\Similarity\DefaultSimilarity();
        }
     ...
     */
    public function idf($input, \Maho\Search\Lucene\LuceneInterface $reader)
    {
        if (!is_array($input)) {
