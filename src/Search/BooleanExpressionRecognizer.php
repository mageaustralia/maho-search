 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class BooleanExpressionRecognizer extends \Maho\Search\Lucene\FSM
{
    ...
    public function __construct()
    {
        ...
        $emptyOperatorAction    = new \Maho\Search\Lucene\FSMAction($this, 'emptyOperatorAction');
        $emptyNotOperatorAction = new \Maho\Search\Lucene\FSMAction($this, 'emptyNotOperatorAction');
        ...
        $notOperatorAction     = new \Maho\Search\Lucene\FSMAction($this, 'notOperatorAction');
        $orOperatorAction      = new \Maho\Search\Lucene\FSMAction($this, 'orOperatorAction');
        $literalAction         = new \Maho\Search\Lucene\FSMAction($this, 'literalAction');
    ...
    public function finishExpression()
    {
        if ($this->getState() != self::ST_LITERAL) {
            ...
            throw new \Maho\Search\Lucene\Exception('Literal expected.');
        }
