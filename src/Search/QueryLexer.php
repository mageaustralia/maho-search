...
class QueryLexer extends \Maho\Search\Lucene\FSM
{
    ...
    public function __construct()
    {
        ...
        $lexemeModifierErrorAction    = new \Maho\Search\Lucene\FSMAction($this, 'lexModifierErrException');
        $quoteWithinLexemeErrorAction = new \Maho\Search\Lucene\FSMAction($this, 'quoteWithinLexemeErrException');
        $wrongNumberErrorAction       = new \Maho\Search\Lucene\FSMAction($this, 'wrongNumberErrException');
        ...
        /** Actions */
        $syntaxLexemeAction    = new \Maho\Search\Lucene\FSMAction($this, 'addQuerySyntaxLexeme');
        $lexemeModifierAction  = new \Maho\Search\Lucene\FSMAction($this, 'addLexemeModifier');
        $addLexemeAction       = new \Maho\Search\Lucene\FSMAction($this, 'addLexeme');
        $addQuotedLexemeAction = new \Maho\Search\Lucene\FSMAction($this, 'addQuotedLexeme');
        $addNumberLexemeAction = new \Maho\Search\Lucene\FSMAction($this, 'addNumberLexeme');
        $addLexemeCharAction   = new \Maho\Search\Lucene\FSMAction($this, 'addLexemeChar');
    ...
    public function addQuerySyntaxLexeme()
    {
        ...
        $token = new \Maho\Search\Lucene\Search\QueryToken(
                                \Maho\Search\Lucene\Search\QueryToken::TC_SYNTAX_ELEMENT,
                                $lexeme,
                                $this->_queryStringPosition);
        ...
        if ($token->type == \Maho\Search\Lucene\Search\QueryToken::TT_FIELD_INDICATOR) {
            ...
            $token->type = \Maho\Search\Lucene\Search\QueryToken::TT_FIELD;
        }
    ...
    {
        $this->_lexemes[] = new \Maho\Search\Lucene\Search\QueryToken(
                                    \Maho\Search\Lucene\Search\QueryToken::TC_SYNTAX_ELEMENT,
    ...
    {
        $this->_lexemes[] = new \Maho\Search\Lucene\Search\QueryToken(
                                    \Maho\Search\Lucene\Search\QueryToken::TC_WORD,
                                    $this->_currentLexeme,
    ...
    {
        $this->_lexemes[] = new \Maho\Search\Lucene\Search\QueryToken(
                                    \Maho\Search\Lucene\Search\QueryToken::TC_PHRASE,
                                    $this->_currentLexeme,
                                    $this->_queryStringPosition);
    ...
    {
        $this->_lexemes[] = new \Maho\Search\Lucene\Search\QueryToken(
                                    \Maho\Search\Lucene\Search\QueryToken::TC_NUMBER,
                                    $this->_currentLexeme,
                                    $this->_queryStringPosition - 1);
        $this->_currentLexeme = '';
    }
