 ...
 * @subpackage Search
 */
class MultiTerm extends \Maho\Search\Lucene\Search\Weight
{
    /**
     * IndexReader.
     *
    ...
    /**
     * Query terms weights
     * Array of \Maho\Search\Lucene\Search\Weight\Term
     *
     * @var array
     */
    private $_weights;
    ...
    /**
     * \Maho\Search\Lucene\Search\Weight\MultiTerm constructor
                                ...
                                \Maho\Search\Lucene\LuceneInterface    $reader)
    {
        ...
        foreach ($query->getTerms() as $id => $term) {
            if ($signs === null || $signs[$id] === null || $signs[$id]) {
                $this->_weights[$id] = new \Maho\Search\Lucene\Search\Weight\Term($term, $query, $reader);
