        ...
        switch ($tokenCategory) {
            ...
            case self::TC_SYNTAX_ELEMENT:
                switch ($tokenText) {
                    ...
                    default:
                        throw new \Maho\Search\Lucene\Exception('Unrecognized query syntax lexeme: \'' . $tokenText . '\'');
                }
                break;
            ...
            default:
                throw new \Maho\Search\Lucene\Exception('Unrecognized lexeme type: \'' . $tokenCategory . '\'');
        }
    }
}
