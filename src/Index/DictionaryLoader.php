...
class DictionaryLoader
{
    ...
    public static function load($data)
    {
        ...
        for ($count = 0; $count < $indexTermCount; $count++) {
            ...
            // $termValue        = \Maho\Search\Lucene\Index\Term::getPrefix($prevTerm, $termPrefixLength) . $termSuffix;
            $pb = 0; $pc = 0;
            ...
            // $this->_termDictionary[] =  new \Maho\Search\Lucene\Index\Term($termValue, $termFieldNum);
            $termDictionary[] = array($termFieldNum, $termValue);

            $termInfos[] =
                 // new \Maho\Search\Lucene\Index\TermInfo($docFreq, $freqPointer, $proxPointer, $skipDelta, $indexPointer);
