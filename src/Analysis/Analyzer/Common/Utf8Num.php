...
class Utf8Num extends \Maho\Search\Lucene\Analysis\Analyzer\Common
{
    /**
    ...
    public function __construct()
    {
        if (@preg_match('/\pL/u', 'a') != 1) {
            ...
            throw new \Maho\Search\Lucene\Exception('Utf8Num analyzer needs PCRE unicode support to be enabled.');
        }
    }
    ...
    public function nextToken()
    {
        ...
        do {
            ...
            $token = $this->normalize(new \Maho\Search\Lucene\Analysis\Token($matchedWord, $startPos, $endPos));
