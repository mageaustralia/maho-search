...
class Utf8 extends \Maho\Search\Lucene\Analysis\Analyzer\Common
{
    /**
    ...
    public function __construct()
    {
        if (@preg_match('/\pL/u', 'a') != 1) {
            ...
            throw new \Maho\Search\Lucene\Exception('Utf8 analyzer needs PCRE unicode support to be enabled.');
        }
    }
