...
class LockManager
{
     ...
     *
     * @param \Maho\Search\Lucene\Storage\Directory $lockDirectory
     * @return \Maho\Search\Lucene\Storage\File
     * @throws \Maho\Search\Lucene\Exception
     */
    public static function obtainWriteLock(\Maho\Search\Lucene\Storage\Directory $lockDirectory)
    {
     ...
     * @param \Maho\Search\Lucene\Storage\Directory $lockDirectory
     */
    public static function releaseWriteLock(\Maho\Search\Lucene\Storage\Directory $lockDirectory)
    {
     ...
     * @throws \Maho\Search\Lucene\Exception
     */
    private static function _startReadLockProcessing(\Maho\Search\Lucene\Storage\Directory $lockDirectory)
    {
     ...
     * @param \Maho\Search\Lucene\Storage\Directory $lockDirectory
     */
    private static function _stopReadLockProcessing(\Maho\Search\Lucene\Storage\Directory $lockDirectory)
    {
     ...
     *
     * @param \Maho\Search\Lucene\Storage\Directory $defaultLockDirectory
     * @return \Maho\Search\Lucene\Storage\File
     * @throws \Maho\Search\Lucene\Exception
     */
    public static function obtainReadLock(\Maho\Search\Lucene\Storage\Directory $lockDirectory)
    {
     ...
     * @param \Maho\Search\Lucene\Storage\Directory $lockDirectory
     */
    public static function releaseReadLock(\Maho\Search\Lucene\Storage\Directory $lockDirectory)
    {
     ...
     * @return boolean
     */
    public static function escalateReadLock(\Maho\Search\Lucene\Storage\Directory $lockDirectory)
    {
     ...
     * @param \Maho\Search\Lucene\Storage\Directory $lockDirectory
     */
    public static function deEscalateReadLock(\Maho\Search\Lucene\Storage\Directory $lockDirectory)
    {
        $lock = $lockDirectory->getFileObject(self::READ_LOCK_FILE);
        $lock->lock(LOCK_SH);
    }
     ...
     * @return mixed
     */
    public static function obtainOptimizationLock(\Maho\Search\Lucene\Storage\Directory $lockDirectory)
    {
     ...
     * @param \Maho\Search\Lucene\Storage\Directory $lockDirectory
     */
    public static function releaseOptimizationLock(\Maho\Search\Lucene\Storage\Directory $lockDirectory)
    {
